...
################### Attacker model ############################
attacker = gg.attack.untargeted.MinMaxPoisoning(graph, device=device, seed=123).process(trainer, splits.train_nodes)
...
perturbed prediction 79.88%
The accuracy has gone down 3.62%"""
