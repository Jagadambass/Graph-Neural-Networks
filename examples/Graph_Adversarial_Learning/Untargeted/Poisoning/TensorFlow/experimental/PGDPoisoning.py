...
################### Attacker model ############################
attacker = gg.attack.untargeted.PGDPoisoning(graph, device=device, seed=123).process(trainer, splits.train_nodes)
...
perturbed prediction 76.56%
The accuracy has gone down 6.94%"""
